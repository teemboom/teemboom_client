var clear_land = (function (exports) {
	...
	function normalizeProvidedUser(providedUser) {
	  ...
	  const profilePic = providedUser?.profilePic || providedUser?.profile_pic || null;
	  return {
	    ...providedUser,
	    _id: `${userId}`,
	    id: `${providedUser?.id || providedUser?.userId || providedUser?.user_id || userId}`,
	    userId: `${providedUser?.userId || providedUser?.user_id || userId}`,
	    username,
	    profilePic,
	...
	function getAuthSignInUrl(apiUrl, authenticationType) {
	  let colorMode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "light";
	  if (authenticationType === "username") return `${apiUrl}/auth/username?theme=${colorMode}`;
	  if (authenticationType === "signin") return `${apiUrl}/auth/signin?theme=${colorMode}`;
	  return null;
	}
	...
	function EmojiPickerElement$1(_ref) {
	  ...
	  return /*#__PURE__*/jsxRuntimeExports.jsx("div", {
	    className: "teemboomEmojiPickerWrapper",
	    children: /*#__PURE__*/jsxRuntimeExports.jsx("emoji-picker", {
	      ref: ref,
	      className: "light",
	      style: {
	        width: "100%",
	...
	function Loader(_ref) {
	  ...
	  const [isVisible, setIsVisible] = reactExports.useState(delayMs <= 0);
	  reactExports.useEffect(() => {
	    if (delayMs <= 0) {
	      setIsVisible(true);
	      return undefined;
	  ...
	  const sizeClass = size === "sm" ? "teemboomLoader--sm" : "teemboomLoader--md";
	  const layoutClass = inline ? "teemboomLoader--inline" : "teemboomLoader--block";
	  return /*#__PURE__*/jsxRuntimeExports.jsx("div", {
	    className: `teemboomLoader ${sizeClass} ${layoutClass} ${className}`.trim(),
	    role: "status",
	    "aria-live": "polite",
	    children: /*#__PURE__*/jsxRuntimeExports.jsx("span", {
	      className: "teemboomLoaderSpinner",
	      "aria-hidden": "true"
	    })
	  });
	}
	...
	function ProfileMenu(_ref5) {
	  ...
	  const canPromptForAuth = ["username", "signin"].includes(authenticationType);
	  const canLogout = signedIn && !["guest", "provided_user"].includes(authenticationType);
	  ...
	  return /*#__PURE__*/jsxRuntimeExports.jsxs("div", {
	    ...
	    children: [/*#__PURE__*/jsxRuntimeExports.jsx("div", {
	      ...
	      children: [/*#__PURE__*/jsxRuntimeExports.jsx("div", {
	        ...
	        children: heading
	      }), canLogout ? /*#__PURE__*/jsxRuntimeExports.jsx("button", {
	        type: "button",
	        onClick: onLogout,
	        children: "Log Out"
	...
	function CommentItem(_ref1) {
	  ...
	  const textSnippets = config?.text_snippets || {};
	  const replyPlaceholder = textSnippets.reply_placeholder || "Leave a reply...";
	  const sendReplyButtonLabel = textSnippets.send_reply_button || "Reply";
	      ...
	      children: /*#__PURE__*/jsxRuntimeExports.jsxs("div", {
	        ...
	        children: [/*#__PURE__*/jsxRuntimeExports.jsx("div", {
	          ...
	          children: [/*#__PURE__*/jsxRuntimeExports.jsx("div", {
	            ...
	            children: [/*#__PURE__*/jsxRuntimeExports.jsxs("div", {
	            ...
	            }), loadingReplies ? /*#__PURE__*/jsxRuntimeExports.jsx(Loader, {
	              ...
	              children: loadingMoreReplies ? /*#__PURE__*/jsxRuntimeExports.jsx(Loader, {
	                label: "Loading...",
	                size: "sm",
	                inline: true
	              }) : "Load more replies"
	...
	function Widget(_ref10) {
	  ...
	  const requestSignIn = () => {
	    const url = getAuthSignInUrl(resolvedApiUrl, authenticationType, colorMode);
	    if (url) {
	      setAuthIframeHidden(false);
	  ...
	  const handleSend = async function (textarea) {
	    ...
	    // Clear textarea immediately to prevent duplicate submissions
	    const originalValue = textarea.value;
	    textarea.value = "";
	    resizeCommentInput(textarea);
	    let newComment = null;
	    try {
	      newComment = await api.postComment(pageId, comment, actingUser, parentId);
	    } catch (err) {
	      // Restore textarea and alert user
	  ...
	  const textSnippets = config?.text_snippets || {};
	  const writeCommentPlaceholder = textSnippets.write_comment_placeholder || "Leave a comment...";
	  const sendCommentButtonLabel = textSnippets.send_comment_button || "Comment";
	  const resolvedWriteCommentPlaceholder = authenticationType === "signin" && !hasAuthenticatedIdentity ? "Sign in to leave a comment..." : writeCommentPlaceholder;
	  if (!config) {
	    return /*#__PURE__*/jsxRuntimeExports.jsx("div", {
	    ...
	    children: /*#__PURE__*/jsxRuntimeExports.jsxs("div", {
	      ...
	      children: [/*#__PURE__*/jsxRuntimeExports.jsxs("div", {
	        ...
	        children: [/*#__PURE__*/jsxRuntimeExports.jsx("div", {
	          ...
	          rows: 1,
	          placeholder: resolvedWriteCommentPlaceholder,
	          ...
	          children: [/*#__PURE__*/jsxRuntimeExports.jsx("button", {
	            ...
	            children: sendCommentButtonLabel
	          }), /*#__PURE__*/jsxRuntimeExports.jsx(ComposerActions, {
	        ...
	        children: loading ? /*#__PURE__*/jsxRuntimeExports.jsx(Loader, {
	...
	function mountWidget() {
	  ...
	  const pageId = options.pageId || generatePageId();
	 ...
	 * @param {string} [options.pageId] - Optional: Unique page identifier. If not provided, auto-generated from URL
	 * @param {"light"|"dark"} [options.colorMode] - Optional: Force a color mode. Omit to auto-detect from system preference (prefers-color-scheme).
	 * @param {{username?: string, name?: string, id?: string, _id?: string, userId?: string, profilePic?: string|null}} [options.user] - Optional: External user identity for `provided_user` authentication.
